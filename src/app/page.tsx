    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pi-section { background:linear-gradient(180deg,#f0f5fb 0%,#e8f2fb 100%); }
        ...
        /* ── FORECAST SECTION ── */
        .forecast-section { background:linear-gradient(180deg,#e8f2fb 0%,#dce8f5 100%); }
        ...
        /* ── RESORT LIST SECTION ── */
        .resorts-section { background:linear-gradient(180deg,#f0f5fb 0%,#e8f2fb 100%); }
        ...
        /* ── ANALYTICS SECTION ── */
        .analytics-section { background:linear-gradient(180deg,#dce8f5 0%,#e8f2fb 100%); padding:80px 0; }
