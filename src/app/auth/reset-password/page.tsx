...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    // Supabase puts the session in the URL hash when coming from email link
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .title { font-family:'DM Serif Display',Georgia,serif; font-size:28px; font-weight:400; color:#18304e; text-align:center; margin-bottom:8px; }
        ...
        .success-box { background:rgba(34,197,94,0.08); border:1px solid rgba(34,197,94,0.3); color:#15803d; border-radius:10px; padding:16px; font-size:14px; margin-bottom:18px; line-height:1.5; text-align:center; }
        .field { margin-bottom:16px; }
        label { display:block; font-size:13px; font-weight:600; color:#263d58; margin-bottom:7px; }
        .input-wrap { position:relative; }
        input { width:100%; background:rgba(238,246,255,0.75); border:1.5px solid rgba(170,205,238,0.9); border-radius:12px; padding:12px 48px 12px 16px; font-size:15px; font-family:'DM Sans',system-ui,sans-serif; color:#18304e; outline:none; transition:border-color 0.18s,box-shadow 0.18s; -webkit-appearance:none; }
        ...
        .pw-toggle { position:absolute; right:12px; top:50%; transform:translateY(-50%); background:none; border:none; cursor:pointer; color:#80a0c0; padding:4px; display:flex; align-items:center; border-radius:6px; transition:color 0.15s; }
        .pw-toggle:hover { color:#2860b8; }
        .submit-btn { width:100%; padding:14px; margin-top:8px; border-radius:12px; border:none; background:linear-gradient(135deg,#5295ec 0%,#2d6fd4 55%,#1a52b0 100%); color:#fff; font-size:16px; font-weight:700; font-family:'DM Sans',system-ui,sans-serif; cursor:pointer; transition:filter 0.18s,transform 0.14s; box-shadow:0 4px 18px rgba(40,100,200,0.38); }
      ...
      <div className="page">
        ...
        <div className="card">
          <div className="logo-wrap">
            <Link href="/"><img src="/brand/powderiq_logo.png" alt="PowderIQ" className="logo-img" /></Link>
          </div>
