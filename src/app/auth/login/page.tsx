      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .login-bg::after {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient(160deg, rgba(210,228,248,0.50) 0%, rgba(185,212,242,0.40) 40%, rgba(200,220,245,0.45) 100%);
        }
        .login-card {
          position: relative;
          z-index: 1;
          ...
          box-shadow: 0 8px 48px rgba(70,110,180,0.16), 0 2px 8px rgba(70,110,180,0.10), inset 0 1px 0 rgba(255,255,255,0.98);
        ...
        .login-sub em { font-style:italic; font-weight:700; color:#2860b8; }
        .error-box {
        ...
        label { font-size:13px; font-weight:600; color:#263d58; letter-spacing:0.005em; }
        .forgot-link { font-size:12px; color:#5080c0; text-decoration:none; font-weight:500; transition:color 0.15s; }
        ...
        .pw-toggle {
          ...
          background:none; border:none; cursor:pointer; color:#80a0c0;
        ...
        .submit-btn {
          ...
          letter-spacing:0.02em; transition:filter 0.18s,transform 0.14s,box-shadow 0.18s;
        ...
        .submit-btn:hover:not(:disabled) { filter:brightness(1.07); transform:translateY(-1px); box-shadow:0 7px 24px rgba(40,100,200,0.46); }
        ...
        .signup-row { text-align:center; margin-top:22px; font-size:14px; color:#6888a8; }
        .signup-row a { color:#2860b8; font-weight:700; text-decoration:none; transition:color 0.15s; }
