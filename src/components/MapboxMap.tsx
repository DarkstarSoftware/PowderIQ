...
export default function MapboxMap({
  ...
  const loadAndRender = useCallback(async (
    ...
    try {
      ...
      // Camera: auto-zoom from ski area span, north-up, 60° pitch
      const autoZoom = computeAutoZoom(geo, _fallbackZoom);
      map.easeTo({ center: [_lon, _lat], zoom: autoZoom, bearing: 0, pitch: 60, duration: 1200 });
    ...
    (async () => {
      try {
        ...
        map = new mgl.Map({
          ...
          center: [lon, lat], zoom, pitch: 60, bearing: 0,
